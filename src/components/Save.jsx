...
export default function Save({ open, onClose, onExport }) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-start justify-center pt-32 bg-black/20">
            <div ref={menuRef} className="bg-[var(--bg)] rounded-2xl shadow-xl p-2 w-56 flex flex-col gap-1">
